...
namespace Reader_347
{
    ...
    public class PDFManager
    {
        ...
        public bool ExportToPDFDraft(Type1Registry type1, List<Declared> declareds)
        {
            try
            {
                ...
                {
                    SetPdfTextFieldValue("untitled68", type1.DeclarantNIF, ref forms); //Declarant NIF
                    SetPdfTextFieldValue("untitled69", type1.RelationsPhone, ref forms); //Declarant phone
                    SetPdfTextFieldValue("untitled70", type1.DeclarantName, ref forms); //Declarant Name
                    SetPdfTextFieldValue("untitled71", type1.LegalRepNIF, ref forms); //NIF Legal Rep
                    SetPdfTextFieldValue("untitled72", type1.Ejercicio, ref forms); //Exercise
                    SetPdfTextFieldValue("untitled73", type1.PrevDeclarationID, ref forms); //Previous declaration ID
                    SetPdfCheckBoxValue("untitled74", type1.IsComplementaryDec, ref forms); //(Checkbox) Comp declaration 1
                    SetPdfCheckBoxValue("untitled75", type1.IsComplementaryDec, ref forms); //(Checkbox) Comp declaration 2
                    SetPdfCheckBoxValue("untitled76", type1.IsSustitutiveDec, ref forms); //(Checkbox) Sust declaration
                    SetPdfTextFieldValue("untitled77", type1.TotalEntities, ref forms); //Total entities
                    SetPdfTextFieldValue("untitled78", type1.TotalAnualMoney, ref forms); //Total anual money
                    SetPdfTextFieldValue("untitled79", type1.TotalProperties, ref forms); //Total properties
                    SetPdfTextFieldValue("untitled80", type1.TotalMoneyRental, ref forms); //Total money rental
                    SetPdfTextFieldValue("untitled81", DateTime.Today.ToLongDateString(), ref forms); //Date
                    SetPdfTextFieldValue("untitled82", type1.RelationsName, ref forms); //Signature (Relation Name placeholder)

                    SetPdfTextFieldValue("untitled14", type1.DeclarantNIF, ref forms);
                    SetPdfTextFieldValue("untitled15", type1.Ejercicio, ref forms);
                    ...
                    {
                        SetPdfTextFieldValue("untitled135", type1.DeclarantNIF, ref forms);
                        SetPdfTextFieldValue("untitled136", type1.Ejercicio, ref forms);
        ...
        [Obsolete("Use el método CreatePDFWithImage")]
